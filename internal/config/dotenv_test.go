...
func TestLoadDotEnvLoadsWorkingDirectoryFileWithoutOverridingExistingEnv(t *testing.T) {
	...
	const newKey = "WHALE2API_TEST_DOTENV_NEW"
	const keepKey = "WHALE2API_TEST_DOTENV_KEEP"
	const quotedKey = "WHALE2API_TEST_DOTENV_QUOTED"

	unsetEnv(t, newKey)
	unsetEnv(t, quotedKey)
	t.Setenv(keepKey, "from-env")

	content := "WHALE2API_TEST_DOTENV_NEW=from-file\n" +
		"WHALE2API_TEST_DOTENV_KEEP=from-file\n" +
		"WHALE2API_TEST_DOTENV_QUOTED=\"line1\\nline2\"\n"
...
func TestLoadDotEnvStripsInlineCommentsFromUnquotedValues(t *testing.T) {
	...
	const plainKey = "WHALE2API_TEST_DOTENV_PLAIN"
	const hashKey = "WHALE2API_TEST_DOTENV_HASH"
	const quotedKey = "WHALE2API_TEST_DOTENV_QUOTED_COMMENT"
	const exportKey = "WHALE2API_TEST_DOTENV_EXPORT"
